...
var index = function (_req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, products_crud.index()];
        case 1:
...
var showProduct = function (_req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
...
var addProduct = function (_req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 4:
          ...
          if (
            !utils_2.IsValidString(name) ||
            !utils_2.IsValidString(category) ||
            !utils_1.IsValidNumber(price)
          ) {
            res.status(400);
            res.json("Invalid input");
            return [2 /*return*/];
...
var deleteProduct = function (_req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
...
var getPopProducts = function (_req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    var id, pop_products;
    return __generator(this, function (_a) {
      switch (_a.label) {
...
var getProductsByCat = function (_req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    var category, products, err_5;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          category = _req.query.category;
          if (!utils_2.IsValidString(category)) {
            res.status(400);
            res.json("Invalid input");
            return [2 /*return*/];
          }
