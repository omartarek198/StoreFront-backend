...
var index = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!utils_4.validate(_req, res)) return [3 /*break*/, 2];
                return [4 /*yield*/, usrs_crud.index()];
            case 1:
                all_users = _a.sent();
                res.json(all_users);
                _a.label = 2;
...
var addUsr = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var fn, ln, pwd, added_usr, token, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                fn = _req.query.fn;
...
var showUser = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, id, target_user, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!utils_4.validate(_req, res)) {
                    return [2 /*return*/];
                }
